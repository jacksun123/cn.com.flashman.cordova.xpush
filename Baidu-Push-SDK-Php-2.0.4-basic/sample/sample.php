...
$apiKey = "YYWwiP0RXLeRdhx6BECbIQnD";
$secretKey = "91S7QtCmQsmlxTmKCIFzYILGFmrNK9uF";

//测试发送单条消息
test_pushMessage_android('599526847539396649');
...
function test_pushMessage_android ($user_id)
{
    ...
    $message = '{ 
            "title": "你收到一新新消息标题",
            "description": "消息提醒的内容消息提醒的内容消息提醒的内容消息提醒的内容消息提醒的内容",
            "custom_content": {"ccc":"333","bbb":"222","aaa":"111"}, //自定义的数据结构
