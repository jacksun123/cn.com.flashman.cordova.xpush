...
public class BaiduMessageReceiver extends FrontiaPushMessageReceiver {
	/** TAG to Log */
	public static final String TAG = "TAG"; // BaiduMessageReceiver.class.getSimpleName();
	...
	public void onBind(Context context, int errorCode, String appid,
		...
		try {
			...
			Baidu.messageQueue.push(r);
		} catch (JSONException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}

		Baidu.pushCallback(r);
	}
	...
	public void onMessage(Context context, String message,
		...
		try {
			...
			if (customContentString != null)
				r.put("custom", new JSONObject(customContentString));
			Baidu.messageQueue.push(r);
		} catch (JSONException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public void onSetTags(Context context, int errorCode,
		...
		try {
			...
			r.put("sucessTags", sucessTags);
			r.put("failTags", failTags);
			r.put("requestId", requestId);
			Baidu.messageQueue.push(r);
		} catch (JSONException e) {
			// TODO Auto-generated catch block
